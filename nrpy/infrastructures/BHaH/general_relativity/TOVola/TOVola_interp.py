...
def register_CFunction_TOVola_TOV_interpolate_1D() -> None:
    ...
    Provides spectral interpolator to provide data at arbitrary point radius.
    """
    includes = ["BHaH_defines.h"]
    desc = "Provide high-order 1D Lagrange polynomial interpolation from TOVola grids to arbitrary radius rr_iso."
    prefunc = r"""
...
"""
    ...
    params = r"""
  REAL rr_iso, const commondata_struct *restrict commondata,
