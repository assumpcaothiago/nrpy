/* nanoflann_bridge.h
 *
 * C API bridge for using nanoflann (C++) from BHaH (C).
 *
 * This header is C-compatible and can be included from .c files.
 */
 ...
 * :param x_index: Index (within a particle record) of x coordinate.
 * :param y_index: Index (within a particle record) of y coordinate.
 * :param z_index: Index (within a particle record) of z coordinate.
 * :return tree: Pointer to KD-tree handle, or NULL on failure.
 */
BHaH_KDTree *BHaH_kdtree_build_3d(int npts, const double *data, int stride,
 ...
 * :return rc: 0 on success; nonzero on failure.
 */
int BHaH_kdtree_query_1nn_3d(const BHaH_KDTree *tree, const double query_pt[3],
