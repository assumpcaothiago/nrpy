...
Authors: Leonardo Rosa Werneck; wernecklr **at** gmail **dot* com
...
BHaH.general_relativity.TOVola.TOVola_interpolate_1D.register_CFunction_TOVola_TOV_interpolate_1D()
...
if CoordSystem == "SinhSpherical":
    ...
    par.adjust_CodeParam_default("SINHWRHO", 0.22)
    par.adjust_CodeParam_default("SINHWZ", 0.25)
