"""
Generate a minimal NRPy-only Counterexample 2 corrected diagnostic that uses
standard BHaH griddata storage and the Jacobian-aware derivative inner BC.
"""
...
parser = argparse.ArgumentParser(
    description="Generate a minimal corrected Counterexample 2 BHaHAHA diagnostic project."
)
parser.add_argument(
    "--fdorder",
    type=int,
...
parser.add_argument(
    "--project-name",
    type=str,
    default="BHaHAHA-counterexample2-minimal-corrected",
...
dit.corrected_analytic_pipeline.register_error_codes()
...
dit.analytic_pipeline.register_CFunction_counterexample2_fill_analytic_auxevol_fields()
dit.analytic_pipeline.register_CFunction_counterexample2_apply_base_field_inner_bcs()
dit.corrected_analytic_pipeline.register_CFunctions()
...
print(
    f"Finished! Now go into ./{args.outrootdir}/{args.project_name} and type `make` to build the corrected diagnostic,"
